    ...
    while True:
        ...
        for cnt in contours_red:
            ...
            if contour_area > 2000:
                ...
                pos = ff.find_pos(color_image,h,x+int(w)//2 ,y+int(h)//2)
        ...
        for cnt in contours_green:
            ...
            if contour_area > 2000:
                x, y, w, h = cv2.boundingRect(cnt)
                pos = ff.find_pos(color_image,h,x+int(w)//2 ,y+int(h)//2)
                cv2.rectangle(depth_colormap, (x-(int(pos[6]-w)), y), (x + w, y + h), (0, 255, 0), 2)
                cv2.rectangle(color_image, (x-(int(pos[6]-w)), y), (x + w, y + h), (0, 255, 0), 2)
                cv2.circle(color_image,(x-(int(pos[6])-w)+w ,y+int(h)//2 ),2,(0,0,255),5)
                cv2.circle(depth_colormap,(x-(int(pos[6])-w)+w ,y+int(h)//2 ),2,(0,0,255),5)
                pos2 = ff.find_pos(color_image,h,(x-(int(pos[6])-w)+w),y+int(h)//2)
        ...
        for cnt in contours_blue:
            ...
            if contour_area > 2000:
                ...
                cv2.rectangle(depth_colormap, (x-(int(pos[6]-w)), y), ((x+int(pos[6])+ w) , y + h), (255, 0, 0), 2)
                cv2.rectangle(color_image, (x-(int(pos[6]-w)), y), ((x+int(pos[6])+ w) , y + h), (255, 0, 0), 2)
                cv2.circle(color_image,(x-(int(pos[6])-w)+w ,y+int(h)//2 ),2,(0,0,255),5)
                cv2.circle(depth_colormap,(x-(int(pos[6])-w)+w ,y+int(h)//2 ),2,(0,0,255),5)
